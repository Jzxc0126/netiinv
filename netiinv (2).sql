...
INSERT INTO `files_tbl` (`fileid`, `itemid`, `filename`, `file_deleted`) VALUES
...
(3, 'CBNT-FDC-001', 'Sample_Orocan', 'Loks', '', '', 2, 2, 3, 2, 8, 1, 1, 1, '1', 0, '', '', NULL),
...
(34, 'DTOP-NTTC-001', 'HP PRODESK 400 G7 MICROTOWER PC', ' Hewlett-Packard', '', '', 1, 1, 4, 4, 2, 1, 2, 1, '2', 0, '2023-05-06', '', NULL),
